...
function Promotion23() {
	...
	return(
		...
		<body>	
			...
			<div class="centertext">Last updated: 6/15/23</div><br/><br/><br/>
...
(i) Each validated Showcase that is submitted will be counted as two Points and total Showcase Points may not exceed 25% of Total Points before Unique Fan bonus is applied.
...
1. HOW TO ENTER: Beginning on January 1st, 2023 through December 15, 2023 (the “Promotion Period”), log-in to the Pobblebonk app using your Comedian account, and begin checking-in to open-mics.
 ...
 4. WINNER SELECTION: Winners will be determined as follows:
 	...
 	(a) Each registered check-in during the Promotion Period by an individual Comedian will be counted as one point.
(b) Each registered check-in during the Promotion Period by an individual Comedian that is verified by either a Fan or Comedian will count as one point.


 5. PRIZES:
   Comedian with the most points collected during the Promotion Period will receive $100, a T-shirt, and will be named “Hardest Working Comic 2023”
...
`}
			...
			<u><div class="centertext">Top Fan</div></u>
...
(a) Each registered check-in during the Promotion Period by an individual Fan will be counted as one point.
(b) Each vote cast for Top Comic will be counted as two points.
(c) Filling in your Top Five Comics slots will be counted as one point.
(d) Unique Comedian bonus are points that will be added as follows: (10% of Total Points received in (a)-(c)*amount of unique Comedians validated.  By way of example:
	i. Fan A sees 20 comedians throughout the Promotion Period and validated 10 unique Comedians.  Their Promotion Score will be 20+(20*10%*10)=40
	Ii. Fan B sees 15 comedians throughout the Promotion Period and validated 10 unique Comedians.  Their Promotion Score will be 15+(15*10%*10) = 30
	
(c) Points from (a) and (b) will be tallied to result in “Total Fan Points”
