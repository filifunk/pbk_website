	...
	<div className="App-privacy">
        ...
        &emsp;(e) By way of example: <br/>
            ...
            &emsp;&emsp;(ii) Fan B: Checks into 10 mics.  4 of the mics are unique mics. <br/>
				...
				&emsp;(d)Comedians who submit the top 10 most checked-into mics will will get a Pobblebonk T-shirt.  If a different comedian is the "Mic Contact" (as defined in the app) than the submitter, the comedian who was the Mic Contact when the mic achieved the most check-ins over the Promotion Period will also get the a Pobblebonk T-shirt. <br /><br />
